...
public class EditProfileAct extends AppCompatActivity {
    ...
    Button btn_save, btn_add_new_photo, btn_view_dev;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_view_dev= findViewById(R.id.btn_view_dev);
        ...
        btn_view_dev.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent gotodevapps = new Intent(EditProfileAct.this, BioAct.class);
                startActivity(gotodevapps);
            }
        });
    }
